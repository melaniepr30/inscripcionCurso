...
<body>
  ...
  <section>
      ...
      <h2><em>Inscripción a cursos</em></h2>
          ...
          <option value="">Selecciona</option>
          <option value="rally_buenComer">"Rally del buen comer"</option>
          <option value="carrera ">Carrera entre amigos</option>
          <option value="ActivaciónFísica">Activación Física y recreo activo</option>
          <option value="procesosMatemáticos">Conceptos básicos para los procesos matemáticos</option>
		      <option value="AcertijosMatemáticos">Acertijos matemáticos</option>
		      <option value="niñoCamara">Niño a la cámara"</option>
		      <option value="rally_convivencia">Rally de convivencia escolar</option>
          <option value="planeacion">Planeación (Ajustes razonables)</option>
          <option value="circuito">Circuito motriz</option>
          <option value="calculo">Cálculo mental</option>
          </select>
