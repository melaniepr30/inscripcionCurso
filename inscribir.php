...
$db_table_name1="acertijos_matematicos";
$db_table_name2="activacion_fisica";
$db_table_name3="calculo_mental";
$db_table_name4="carrera_amigos";
$db_table_name5="circuito_motriz";
$db_table_name6="conceptos_basicos";
$db_table_name7="niño_camara";
$db_table_name8="planeacion";
$db_table_name9="rally_buencomer";
$db_table_name10="rally_convivencia";
//$db_table_name11="";
//$db_table_name12="";
//$db_table_name13="";
//$db_table_name14="";
...
switch ($subs_cursouno) {
	case 'acertijos_matematicos':
		$tabla1=$db_table_name1;

		break;
	case 'Activación Física':
						...
						if ($dos =='TRUE') {
							...
							if (!$retry_value && !$retry_value1) {
								...
								$_SESSION['curso_dos']=$nombre_dos;
							 	...
							 	?>
								<script language="javascript">
								alert("La inscripción se realizó exitosamente");window.location.href="exito.php";
								</script>
								<?php
							}
